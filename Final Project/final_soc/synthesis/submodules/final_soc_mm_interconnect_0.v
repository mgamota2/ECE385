...
module final_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_005_src_valid;                                                              // cmd_mux_005:src_valid -> add_accumulate_s1_agent:cp_valid
	wire  [105:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> add_accumulate_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                              // add_accumulate_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire   [12:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> add_accumulate_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                                      // cmd_mux_005:src_startofpacket -> add_accumulate_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                        // cmd_mux_005:src_endofpacket -> add_accumulate_s1_agent:cp_endofpacket
	...
	wire          cmd_mux_010_src_valid;                                                              // cmd_mux_010:src_valid -> key_external_connection_s1_agent:cp_valid
	wire  [105:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> key_external_connection_s1_agent:cp_data
	wire          cmd_mux_010_src_ready;                                                              // key_external_connection_s1_agent:cp_ready -> cmd_mux_010:src_ready
	wire   [12:0] cmd_mux_010_src_channel;                                                            // cmd_mux_010:src_channel -> key_external_connection_s1_agent:cp_channel
	wire          cmd_mux_010_src_startofpacket;                                                      // cmd_mux_010:src_startofpacket -> key_external_connection_s1_agent:cp_startofpacket
	wire          cmd_mux_010_src_endofpacket;                                                        // cmd_mux_010:src_endofpacket -> key_external_connection_s1_agent:cp_endofpacket
	...
	wire  [105:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> spi_0_spi_control_port_agent:cp_data
	...
	wire          add_accumulate_s1_agent_rp_valid;                                                   // add_accumulate_s1_agent:rp_valid -> router_007:sink_valid
	wire  [105:0] add_accumulate_s1_agent_rp_data;                                                    // add_accumulate_s1_agent:rp_data -> router_007:sink_data
	wire          add_accumulate_s1_agent_rp_ready;                                                   // router_007:sink_ready -> add_accumulate_s1_agent:rp_ready
	wire          add_accumulate_s1_agent_rp_startofpacket;                                           // add_accumulate_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          add_accumulate_s1_agent_rp_endofpacket;                                             // add_accumulate_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire          key_external_connection_s1_agent_rp_valid;                                          // key_external_connection_s1_agent:rp_valid -> router_012:sink_valid
	wire  [105:0] key_external_connection_s1_agent_rp_data;                                           // key_external_connection_s1_agent:rp_data -> router_012:sink_data
	wire          key_external_connection_s1_agent_rp_ready;                                          // router_012:sink_ready -> key_external_connection_s1_agent:rp_ready
	wire          key_external_connection_s1_agent_rp_startofpacket;                                  // key_external_connection_s1_agent:rp_startofpacket -> router_012:sink_startofpacket
	wire          key_external_connection_s1_agent_rp_endofpacket;                                    // key_external_connection_s1_agent:rp_endofpacket -> router_012:sink_endofpacket
	...
	wire          add_accumulate_s1_agent_rdata_fifo_src_valid;                                       // add_accumulate_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_005:in_0_valid
	wire   [33:0] add_accumulate_s1_agent_rdata_fifo_src_data;                                        // add_accumulate_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_005:in_0_data
	wire          add_accumulate_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_005:in_0_ready -> add_accumulate_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_005_out_0_valid;                                                  // avalon_st_adapter_005:out_0_valid -> add_accumulate_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_005_out_0_data;                                                   // avalon_st_adapter_005:out_0_data -> add_accumulate_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_005_out_0_ready;                                                  // add_accumulate_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_005:out_0_ready
	wire    [0:0] avalon_st_adapter_005_out_0_error;                                                  // avalon_st_adapter_005:out_0_error -> add_accumulate_s1_agent:rdata_fifo_sink_error
	...
	wire          key_external_connection_s1_agent_rdata_fifo_src_valid;                              // key_external_connection_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_010:in_0_valid
	wire   [33:0] key_external_connection_s1_agent_rdata_fifo_src_data;                               // key_external_connection_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_010:in_0_data
	wire          key_external_connection_s1_agent_rdata_fifo_src_ready;                              // avalon_st_adapter_010:in_0_ready -> key_external_connection_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_010_out_0_valid;                                                  // avalon_st_adapter_010:out_0_valid -> key_external_connection_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_010_out_0_data;                                                   // avalon_st_adapter_010:out_0_data -> key_external_connection_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_010_out_0_ready;                                                  // key_external_connection_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_010:out_0_ready
	wire    [0:0] avalon_st_adapter_010_out_0_error;                                                  // avalon_st_adapter_010:out_0_error -> key_external_connection_s1_agent:rdata_fifo_sink_error
